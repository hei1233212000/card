package com.lado.common.config;
...
public class DataSourceConfig {
	...
	public EbeanServer getDefaultEbeanServer() {
		...
		Arrays.asList(NameCard.class, UserDeviceNameCardMapping.class, UserDeviceNameCardMapping.UserDeviceNameCardMappingPk.class).forEach(config::addClass);
